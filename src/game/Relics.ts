...
export const RELICS: Record<RelicId, Relic> = {
  ...
  featherroll: { id: 'featherroll', name: 'Feather Roll', desc: 'Rolling costs 40% less stamina', color: 0xd8f0ff },
  ...
  flametrail: { id: 'flametrail', name: 'Flame Trail', desc: 'Rolling through enemies burns them', color: 0xff6a10 },
